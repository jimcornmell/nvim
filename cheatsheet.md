...
# |<kbd>Ctrl</kbd>-<kbd>s</kbd>|                                                            Save the current file :star: |
# |`:w file`|                                                                    Save to `file`|
...
|__Function Keys__||
|<kbd>F1</kbd>|                                                                Open this cheatsheet :star: |
|<kbd>F2</kbd>|                                                                Cycle through different folding methods :star: |
|<kbd>F3</kbd>|                                                                Toggle most visual items :star: |
# |<kbd>F4</kbd>|                                                                Open left file menu :star: |
|<kbd>F5</kbd>|                                                                Kitty command - assumes text highlighted is a filename and opens it :star: |
|<kbd>F6</kbd>|                                                                Runs the last range substitute, see * and & :star: |
|<kbd>F7</kbd>|                                                                Diff current buffer and next (split and windo diffthis) :star: |
|<kbd>F8</kbd>|                                                                Open Lazygit :star: |
|<kbd>F9</kbd>|                                                                Open Telescope :star: |
|<kbd>F10</kbd>|                                                               Kitty command - New terminal in new tab :star: |
|<kbd>F11</kbd>|                                                               Kitty command - full screen :star: |
|<kbd>F12</kbd>|                                                               Toggle right tags bar :star: |
...
|<kbd>c</kbd><kbd>s</kbd><kbd>"</kbd><kbd>'</kbd>|                             "aWord" to 'aWord' :star: |
|<kbd>c</kbd><kbd>s</kbd><kbd>'</kbd><kbd>"</kbd>|                             'aWord' to "aWord" :star: |
|<kbd>c</kbd><kbd>s</kbd><kbd>'</kbd><kbd>&lt;</kbd><kbd>q</kbd><kbd>&gt;</kbd>|'aWord' to &lt;q&gt;aWord&lt;/q&gt; :star: |
|<kbd>d</kbd><kbd>s</kbd><kbd>'</kbd>|                                         'aWord' to aWord :star: |
|<kbd>y</kbd><kbd>s</kbd><kbd>i</kbd><kbd>w</kbd><kbd>]</kbd>|                 aWord to [aWord] :star: |
|<kbd>y</kbd><kbd>s</kbd><kbd>i</kbd><kbd>W</kbd><kbd>"</kbd>|                 $var_or_word to "$var_or_word" :star: |
|<kbd>g</kbd><kbd>"</kbd>|                                                     fix quote, SHORTCUT FOR LINE ABOVE :star: |
|<kbd>g</kbd><kbd>'</kbd>|                                                     fix quote, SHORTCUT FOR LINE ABOVE but ' :star: |
|<kbd>g</kbd><kbd>`</kbd>|                                                     fix quote, SHORTCUT FOR LINE ABOVE but ` :star: |
...
|`:[range]!column -t`|                                                         Tabulate range :star: |
...
|`:[range]!par`|                                                               Format range :star: |
|`:[range]!par j1w80`|                                                         Format range to j1w80|
|<kbd>g</kbd><kbd>w</kbd>|                                                     Wrap, quick format current paragraph :star: |
...
|<kbd>Alt</kbd>-<kbd>Down</kbd>|                                                          Move current line/selection down 1 line :star: |
...
|<kbd>Ctrl</kbd>-<kbd>l</kbd>|                                                            Redraws the screen and removes any search highlighting :star: |
|<kbd>Alt</kbd>-<kbd>P</kbd>|                                                             Pushes words to right to align with line above :star: |
...
|<kbd>Q</kbd>|                                                                 Play macro <kbd>q</kbd>, shortcut for <kbd>@q</kbd> :star: |
|`:%norm @x`|                                                                  Run macro @x on all lines|
|`:5,10norm @x`|                                                               Run macro @x on lines 5-10|

|__Commenting__||
|<kbd>Ctrl</kbd>-<kbd>/</kbd>|                                                            (un)Comment a line and move to the next.<br/> - I've tweaked the commenter to comment the currentline (or uncomment) and then move to the next.<br/> - Or you can relect and range and then comment, try <kbd>v</kbd><kbd>i</kbd><kbd>p</kbd><kbd>Ctrl-/</kbd><br/> - I find this really handy! :star: |
